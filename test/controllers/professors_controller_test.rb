...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { fname: @professor.fname, lname: @professor.lname, mi: @professor.mi, status: @professor.status, units: @professor.units }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { fname: @professor.fname, lname: @professor.lname, mi: @professor.mi, status: @professor.status, units: @professor.units }
    assert_redirected_to professor_path(assigns(:professor))
  end
